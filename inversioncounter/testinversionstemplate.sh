...
run_test_args "slow" "$(seq -s " " 30 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 435"
run_test_args "slow" "$(seq -s " " 50 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 1225"
run_test_args "slow" "$(seq -s " " 100 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
run_test_args "slow" "$(seq -s " " 50000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 1249975000"
run_test_args "slow" "$(seq -s " " 75000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 2812462500"
# END slow tests
...
run_test_args "" "$(seq -s " " 30 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 435"
run_test_args "" "$(seq -s " " 50 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 1225"
run_test_args "" "$(seq -s " " 100 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
run_test_args "" "$(seq -s " " 50000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 1249975000"
run_test_args "" "$(seq -s " " 75000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 2812462500"
