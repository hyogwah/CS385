...
int main(int argc, char *argv[]) {
    ...
    // If you want to pass the vector's internal array to the quickselect() function, simply use &values[0].
    int *array = &values[0];
    int size = values.size();
    int smallest = quick_select(array, size, k);
    cout << "Smallest element " << k << ": " << smallest << endl;
    return 0;
}
